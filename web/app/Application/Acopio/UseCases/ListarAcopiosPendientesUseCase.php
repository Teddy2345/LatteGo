...
/**
 * Lista los acopios registrados offline que aun no fueron sincronizados.
 */
final class ListarAcopiosPendientesUseCase
{
    ...
    public function ejecutar(): array
    {
        return array_map(
            ...
            $this->acopios->listarPendientesSincronizacion(),
        );
    }
}
