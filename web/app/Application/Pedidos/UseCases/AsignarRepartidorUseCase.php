...
final class AsignarRepartidorUseCase
{
    ...
    public function ejecutar(int $id, int $repartidorId): PedidoData
    {
        ...
        return PedidoData::desdeEntidad($this->pedidos->guardar($pedido->asignarRepartidor($repartidorId)));
    }
}
